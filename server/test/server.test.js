...
describe('GET /todos/:id',()=>{
  ...
  it('it should not return todo doc created another user',(done)=>{
    request(app)
...
describe('PATCH /todos/:id',()=>{
  it('should update the todo of the user',(done)=>{
    var hexID = todos[0]._id.toHexString();
    var text = 'Setting text when testing with completed TRUE'
  ...
  it('should clear completedAt when todo is not completed',(done)=>{
    var hexID = todos[1]._id.toHexString();
    var text = 'Setting text when testing with completed FALSE'
...
describe('GET /users/me', ()=>{
  ...
  it('should return 401 iof not authernticated',(done)=>{
    request(app)
      .get('/users/me')
      .expect(401)
      .expect((res)=>{
...
describe('POST /users/login',()=>{
  it('should login user and return auth key',(done)=>{
    request(app)
      .post('/users/login')
      .send({
        email:users[1].email,
